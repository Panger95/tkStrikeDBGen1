...
public class Main {
	...
	private static String getMacAppPath() {
		return "/Applications/tkStrikeGen1.app";
	}

	// Get the Windows DB path
	private static String getWindowsDBPath() {
		String username = System.getProperty("user.name");
		return "C:\\Users\\" + username + "\\AppData\\Local\\tkStrikeGen1\\app\\db\\tkStrike30.mv.db";
	}

	// Get the Windows application path
	private static String getWindowsAppPath() {
		String username = System.getProperty("user.name");
		return "C:\\Users\\" + username + "\\AppData\\Local\\tkStrikeGen1\\tkStrikeGen1.exe";
	}
}